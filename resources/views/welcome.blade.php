...
<<<<<<< HEAD
                    ...
                    <div class="relative h-48 bg-gradient-to-br from-gray-100 to-gray-200 flex items-center justify-center">
                        ...
                        <span class="absolute top-3 left-3 px-4 py-2 {{ $report['type'] === 'lost' ? 'bg-pink-100 text-pink-800' : 'bg-green-100 text-green-800' }} rounded-full text-sm font-bold uppercase tracking-wide shadow-md">
                            {{ ucfirst($report['type']) }}
                        </span>
                    </div>
                    @endif
